...
def get_parameter_number(net):
    ...
    # CUDA_VISIBLE_DEVICES=0 python train_semseg_rotation.py --batch_size 6 --test_batch_size 16 --npoints 2048 --epoch 300 --model PCT --lr 0.001 --change allaround_STN_16_2048_150_one_more_edgeconv_cos_e2_reversed  --exp training_125 --factor_trans 0.01 --bolt_weight 1 --finetune True  --root /home/bi/study/thesis/data/test
